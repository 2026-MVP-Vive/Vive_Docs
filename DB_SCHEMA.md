...
├─────────────────┤       │
│ id (PK)         │       │        ┌─────────────────────┐
│ mentee_id (FK)  │       │        │  solution_materials │
│ title           │       │        ├─────────────────────┤
│ subject         │◄──────┼────────│ solution_id (FK)    │
│ created_at      │       │        │ file_id (FK)        │
│ updated_at      │       │        └─────────────────────┘
└────────┬────────┘       │
         │                │
         ▼                │
...
│      tasks      │       │
├─────────────────┤       │        ┌─────────────────────┐
│ id (PK)         │       │        │   task_materials    │
│ mentee_id (FK)  │       │        ├─────────────────────┤
│ solution_id (FK)│       ├────────│ task_id (FK)        │
│ title           │       │        │ file_id (FK)        │
│ task_date       │       │        └─────────────────────┘
│ subject         │       │
│ study_time      │       │
...
┌─────────────────┐       ┌─────────────────────┐
│    feedbacks    │       │  overall_feedbacks  │
├─────────────────┤       ├─────────────────────┤
│ id (PK)         │       │ id (PK)             │
│ task_id (FK)    │       │ mentee_id (FK)      │
│ mentor_id (FK)  │       │ mentor_id (FK)      │
│ content         │       │ feedback_date       │
│ summary         │       │ content             │
...
├─────────────────────┤   ├─────────────────────────┤
│ id (PK)             │◄──│ report_id (FK)          │
│ mentee_id (FK)      │   │ subject                 │
│ mentor_id (FK)      │   │ completion_rate         │
│ week_number         │   │ total_study_time        │
│ title               │   │ feedback                │
│ start_date          │   └─────────────────────────┘
│ end_date            │
│ summary             │
